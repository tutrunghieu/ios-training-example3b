...
@property (strong,nonatomic) CategoryVCData* dataSource;
@end
...
- (void)configData {
    [NetworkAccess getJSONDataFromURL:@"http://103.200.20.192:8080/viademy103/start/hash?token=a996899dab72123d319bee80f0e303686f6a51f83d6b6e097cce96f47acde7c2" completion:^(NSDictionary *dictionaryData) {
        self.dataSource = [DataAccessVinh getDataCategory:dictionaryData];
